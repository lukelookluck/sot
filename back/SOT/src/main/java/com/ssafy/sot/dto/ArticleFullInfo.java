...
public class ArticleFullInfo {
	...
	public String toString() {
		return "ArticleFullInfo [id=" + id + ", title=" + title + ", content=" + content + ", boardId=" + boardId
				+ ", boardName=" + boardName + ", userId=" + userId + ", nickname=" + nickname + ", created_at="
				+ created_at + ", updated_at=" + updated_at + ", commentsCnt=" + commentsCnt + ", likesCnt=" + likesCnt
				+ "]";
	}
